...
WITH (
    LOCATION = 'supplier/supplier.tbl',
    DATA_SOURCE = eds_tpch, 
    FILE_FORMAT = ff_pipeDelimited
);
GO
...
WITH (
    LOCATION = 'partsupp/partsupp.tbl',
    DATA_SOURCE = eds_tpch, 
    FILE_FORMAT = ff_pipeDelimited
);
GO
...
WITH (
    LOCATION = 'customer/customer.tbl',
    DATA_SOURCE = eds_tpch, 
    FILE_FORMAT = ff_pipeDelimited
);
GO
...
WITH (
    LOCATION = 'lineitem/lineitem.tbl',
    DATA_SOURCE = eds_tpch, 
    FILE_FORMAT = ff_pipeDelimited
);
GO
